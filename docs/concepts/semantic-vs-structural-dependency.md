...
## Example: Why Space Is Not Nested Under Space Collection

Even though Space is structurally contained within Space Collection, Space does **not** have a semantic dependency on Space Collection:

- You can fully explain what a "Space" is without mentioning Space Collection
- Space is a core concept that stands on its own

Therefore, Space should not be nested under Space Collection's directory.
